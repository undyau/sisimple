...
void CEvent::CheckForBadFinishUnit()
{
...
QString CEvent::FixupSingleResult(QString a_ResultData, long a_ControlId, int a_Adjustment, int a_Offset)
{
...
void CEvent::FixupRawData(long a_ControlId, int a_Adjustment)
{
    for (int i = 0; i < m_OriginalResultsData.size(); i++)
        {
        QString str = m_OriginalResultsData.at(i);
